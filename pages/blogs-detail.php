...
<script src="/Jewelry Store/js/main.js"></script>
<script src="/Jewelry Store/js/process.js"></script>
<?php include '../includes/header.php'; ?>
<div class="blog-detail">
    <h1 class="blog-title"><?= htmlspecialchars($bv['tieu_de']) ?></h1>
    
    <div class="blog-meta">
        <i class="fas fa-user"></i> Người đăng: <?= htmlspecialchars($bv['ho_ten'] ?? 'Không rõ') ?> |
    ...
    <div class="blog-content">
        ...
        if (!empty($bv['hinh_anh'])) {
            ...
            $img = htmlspecialchars($bv['hinh_anh']);
            if (preg_match('/^https?:\/\//', $img)) {
                echo '<img class="blog-middle-image" src="' . $img . '" alt="Ảnh giữa bài">';
            } else {
                echo '<img class="blog-middle-image" src="/JewelryStore/images/blogs-detail/' . $img . '" alt="Ảnh giữa bài">';
                echo '<img class="blog-middle-image" src="/JewelryStore/images/blog-detail/' . $img . '" alt="Ảnh giữa bài">';
            }
            echo '</div>';
        }
