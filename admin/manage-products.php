...
<main>
    <div class="admin-dashboard">
      ...
      <div class="box-button">
        ...
        <a href="add-product.php" class="add-btn" style="margin-left: 20px;">+ Thêm sản phẩm mới</a>
      </div>
            ...
            <table class="product-table">
                ...
                <?php if ($result && $result->num_rows > 0):
                    ...
                    <tr>
                        ...
                        <td class="box-button" style=" justify-content: center;">
                            <a href="edit-product.php?id=<?php echo $row['id_san_pham']; ?>" class="action-btn edit-btn">Sửa</a>
                            <a style="margin-left : 12px;" href="delete-product.php?id=<?php echo $row['id_san_pham'];  ?>" class="action-btn delete-btn" onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này?');">Xóa</a>
                        </td>
                    </tr>
                <?php endwhile; else: ?>
