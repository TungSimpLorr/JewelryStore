...
(1, 'SP001', 'VÒNG CỔ ALEXANDRA DIAMOND', 2000000.00, 'Với viên kim cương lấp lánh được cắt gọt tinh xảo, chiếc vòng cổ này là biểu tượng của vẻ đẹp cổ điển và sự sang trọng tuyệt đối. Alexandra Diamond không chỉ là một món trang sức, mà còn là tuyên ngôn về phong cách tinh tế, hoàn hảo cho những quý cô yêu thích sự lộng lẫy và đẳng cấp.', 1, 2, 110.00, 0, 'https://www.christies.com/img/LotImages/2008/HGK/2008_HGK_02628_3016_000(045425).jpg?maxwidth=1390&maxheight=1300', '2025-05-24 17:00:00', '2025-05-24 17:00:00'),
