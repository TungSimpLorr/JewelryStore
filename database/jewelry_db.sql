...
create table `lien_he` (
  `id_lien_he` int(11) not null auto_increment,
...
insert into `danh_muc_bai_viet` (`id_danh_muc`, `ten_danh_muc`, `mo_ta`) values
(1, 'câu chuyện jewelrystore', null),
(2, 'xu hướng-phong cách', null),
(3, 'kiến thức', null);
